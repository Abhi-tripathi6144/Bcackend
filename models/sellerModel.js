...
const sellerSchema = new mongoose.Schema(
  {
    ...
    //Each value in the array is an ObjectId.
    //ObjectId is the unique ID MongoDB gives to each document.
    //So instead of storing full order data, you store just the IDs
    wallet: {
      amount: { type: Number },
    },
    ...
    gst_verification_status: {
      type: String,
      enum: ["Done", "Pending", "Blocked", "Not_Verified"],
